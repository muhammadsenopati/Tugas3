...
public class Barang implements TokoBangunan {
     ...
     * @param persentase  Persentase diskon yang diberikan.
     * @return Harga total setelah diskon.
     */
    public double hitungDiskon(int jumlah, double persentase) {
        double totalHarga = hitungTotalHarga(jumlah); // Memanggil metode hitungTotalHarga yang sudah ada
        return totalHarga - (totalHarga * persentase / 100);
    }
